...
const ProjectsSection = () => {
  ...
  const projects: ProjectEntry[] = [
    ...
    },
    {
      ...
      cardTags: ["V2G / G2V", "Bidirectional VSC", "LCL Filter"],
      titleKey: "proj.v2g.title",
      subtitleKey: "proj.v2g.subtitle",
      statusType: "completed",
      date: "July 2026",
      contexteKey: "proj.v2g.contexte",
      objectifKey: "proj.v2g.objectif",
      contributionKey: "proj.v2g.contribution",
      resultatsKey: "proj.v2g.resultats",
      outils: [
        "MATLAB/Simulink", "Simscape Electrical", "Bidirectional AC/DC VSC", "Buck-Boost DC/DC",
        "LCL Filter", "PLL", "dq Control", "SVPWM", "CC/CV Charging", "Li-ion Battery", "Micro-grid",
      ],
      galleryLabelKey: "proj.v2g.galleryLabel",
      gallery: [
        { src: "/projects/v2g/architecture.png", captionKey: "proj.v2g.cap.architecture" },
        { src: "/projects/v2g/battery-charger.png", captionKey: "proj.v2g.cap.charger" },
        { src: "/projects/v2g/lcl-filter.png", captionKey: "proj.v2g.cap.lcl" },
        { src: "/projects/v2g/grid-currents.png", captionKey: "proj.v2g.cap.currents" },
        { src: "/projects/v2g/v2g-soc.png", captionKey: "proj.v2g.cap.v2g" },
        { src: "/projects/v2g/g2v-voltage.png", captionKey: "proj.v2g.cap.g2v" },
      ],
    },
    {
      categories: ["power", "digital"],
      cardTags: ["Fast DC", "V2G / G2V", "SimPowerSystems"],
      titleKey: "proj.fastdc.title",
      subtitleKey: "proj.fastdc.subtitle",
      statusType: "completed",
      date: "May 2026",
      contexteKey: "proj.fastdc.contexte",
      objectifKey: "proj.fastdc.objectif",
      contributionKey: "proj.fastdc.contribution",
      resultatsKey: "proj.fastdc.resultats",
      outils: [
        "MATLAB/Simulink", "SimPowerSystems", "Fast DC Charging", "V2G / G2V",
        "CC/CV Control", "DC Bus", "3-phase Inverter", "FFT / THD", "Reactive Power",
      ],
      galleryLabelKey: "proj.fastdc.galleryLabel",
      gallery: [
        { src: "/projects/fastdc-ev/simulink-model.jpg", captionKey: "proj.fastdc.cap.model" },
        { src: "/projects/fastdc-ev/ev1-voltage.png", captionKey: "proj.fastdc.cap.ev1v" },
        { src: "/projects/fastdc-ev/ev2-voltage.png", captionKey: "proj.fastdc.cap.ev2v" },
        { src: "/projects/fastdc-ev/ev1-current.png", captionKey: "proj.fastdc.cap.ev1i" },
        { src: "/projects/fastdc-ev/ev2-current.png", captionKey: "proj.fastdc.cap.ev2i" },
        { src: "/projects/fastdc-ev/ev1-soc.png", captionKey: "proj.fastdc.cap.ev1soc" },
        { src: "/projects/fastdc-ev/ev2-soc.png", captionKey: "proj.fastdc.cap.ev2soc" },
      ],
    },
    {
      categories: ["digital", "automation"],
      cardTags: ["IEC 61850", "OCPP", "C# / .NET"],
      titleKey: "proj.iec.title",
      subtitleKey: "proj.iec.subtitle",
      statusType: "completed",
      date: "April 2026",
      contexteKey: "proj.iec.contexte",
      objectifKey: "proj.iec.objectif",
      contributionKey: "proj.iec.contribution",
      resultatsKey: "proj.iec.resultats",
      outils: [
        "C# / .NET", "WinForms", "IEC 61850 SCD", "OCPP", "Python", "WebSockets",
        "MATLAB/Simulink", "matlab.engine", "Virtual Commissioning", "EV Charging",
      ],
    },
    {
      categories: ["power"],
