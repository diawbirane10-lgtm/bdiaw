...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "hero.tagline": "Étudiant en génie électrique et automatisme industriel, orienté systèmes industriels intelligents, programmation d'automates, instrumentation, simulation, jumeaux numériques et systèmes énergétiques.",
    "hero.cta.projects": "Voir mes projets",
    "hero.cta.cv": "Télécharger mon CV",
    "hero.about": "À propos",
    "hero.about1": "Étudiant en génie électrique à la FST Marrakech, je m'intéresse aux systèmes embarqués, à l'automatisation industrielle, au traitement du signal et à l'IA appliquée. J'aime concevoir des systèmes complexes : du firmware aux boucles de régulation, en passant par l'analyse de signaux.",
    "hero.about2": "Je travaille à l'interface du logiciel, de l'électronique et du contrôle-commande avec une approche pragmatique et multidisciplinaire. Mes outils habituels sont MATLAB/Simulink, Python, le C embarqué et les automates programmables. J'apprends en continu parce que bien comprendre un système, c'est la base.",
  ...
  en: {
    ...
    "hero.about": "About",
    "hero.about1": "I'm an Electrical Engineering student at FST Marrakech. My main interests are embedded systems, industrial automation, signal processing, and applied AI. I enjoy designing and modeling complex engineering systems, from firmware and control loops to signal analysis pipelines.",
    "hero.about2": "I work across software, electronics, and control systems with a hands-on, multidisciplinary mindset. My regular tools are MATLAB/Simulink, Python, embedded C, and PLCs. I'm always learning, because actually understanding a system is the starting point for everything.",
  ...
  ar: {
    ...
    "hero.tagline": "طالب في الهندسة الكهربائية والأتمتة الصناعية، متخصص في الأنظمة الصناعية الذكية، برمجة المتحكمات المنطقية، القياس، المحاكاة، التوائم الرقمية وأنظمة الطاقة.",
    "hero.cta.projects": "عرض مشاريعي",
    "hero.cta.cv": "تحميل سيرتي الذاتية",
    "hero.about": "نبذة عني",
    "hero.about1": "أنا طالب في الهندسة الكهربائية بكلية العلوم والتقنيات بمراكش. اهتماماتي الرئيسية هي الأنظمة المدمجة، الأتمتة الصناعية، معالجة الإشارة والذكاء الاصطناعي التطبيقي. أحب تصميم ونمذجة الأنظمة الهندسية المعقدة، من البرمجيات المدمجة وحلقات التحكم إلى خطوط تحليل الإشارات.",
    "hero.about2": "أعمل على تقاطع البرمجيات والإلكترونيات وأنظمة التحكم بنهج عملي متعدد التخصصات. أدواتي المعتادة هي MATLAB/Simulink وPython والـC المدمج والمتحكمات المنطقية. أتعلم باستمرار لأن فهم النظام فعلاً هو نقطة البداية لأي شيء.",
