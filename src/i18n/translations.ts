...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "hero.tagline": "Simulation de réseaux électriques haute tension, contrôle de systèmes de puissance et systèmes embarqués. Recherche HVDC publiée, expérience terrain 225 kV.",
    "hero.cta.projects": "Voir mes projets",
    "hero.cta.cv": "Télécharger mon CV",
    "hero.about": "À propos",
    "hero.about1": "Étudiant en génie électrique à la FST Marrakech, je travaille sur la simulation et le contrôle des réseaux d'énergie : réseaux VSC-HVDC multi-terminaux, stratégies Grid-Forming, stockage d'énergie. Ces travaux ont abouti à un article soumis à évaluation par les pairs (JURI, KFUPM, Réf. JURI-00314-2026-01).",
    "hero.about2": "En parallèle, je conçois des jumeaux numériques et des systèmes embarqués — variateur DC, pack batteries Li-ion, contrôle d'un drone en conditions extrêmes. Mes outils sont MATLAB/Simulink (Simscape Electrical), Python et le C embarqué. Une expérience terrain sur des installations 225 kV complète mon profil.",
  ...
  en: {
    ...
    "hero.tagline": "Power systems simulation, grid-forming control, and embedded systems. Published HVDC research, 225 kV field experience.",
    "hero.cta.projects": "View my projects",
    "hero.cta.cv": "Download my CV",
    "hero.about": "About",
    "hero.about1": "I'm an Electrical Engineering student at FST Marrakech working on power systems simulation and control: multi-terminal VSC-HVDC networks, Grid-Forming strategies, and battery energy storage integration. This work resulted in a paper currently under peer review (JURI, KFUPM — Ref. JURI-00314-2026-01).",
    "hero.about2": "Alongside research, I build digital twins and embedded control systems — a DC drive, a Li-ion battery pack, and a drone power architecture for extreme environments. My core tools are MATLAB/Simulink (Simscape Electrical), Python, and embedded C. Field work on 225 kV HV installations rounds out the profile.",
  ...
  ar: {
    ...
    "hero.tagline": "محاكاة شبكات الطاقة الكهربائية، التحكم Grid-Forming والأنظمة المدمجة. بحث HVDC منشور وخبرة ميدانية على شبكات 225 كيلوفولط.",
    "hero.cta.projects": "عرض مشاريعي",
    "hero.cta.cv": "تحميل سيرتي الذاتية",
    "hero.about": "نبذة عني",
    "hero.about1": "أنا طالب في الهندسة الكهربائية بكلية العلوم والتقنيات بمراكش، أعمل على محاكاة وتحكم شبكات الطاقة: شبكات VSC-HVDC متعددة المحطات، استراتيجيات Grid-Forming ودمج تخزين الطاقة. أسفرت هذه الأعمال عن مقالة خضعت للتحكيم العلمي (JURI، KFUPM — Réf. JURI-00314-2026-01).",
    "hero.about2": "إلى جانب البحث، أبني توائم رقمية وأنظمة تحكم مدمجة: محرك تيار مستمر، حزمة بطاريات ليثيوم وهندسة طاقة طائرة مسيّرة في ظروف قصوى. أدواتي الأساسية هي MATLAB/Simulink (Simscape Electrical) وPython والـC المدمج. تجربة ميدانية على منشآت الجهد العالي 225 كيلوفولط تكمل ملفّي.",
