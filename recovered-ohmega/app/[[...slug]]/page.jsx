...
const researchAbstracts={
  iet:{
    ...
    fr:`Le remplacement de la production synchrone par des ressources éoliennes, solaires et de stockage interfacées par convertisseurs réduit la réponse cinétique naturelle disponible après un déséquilibre de puissance. Les parcs éoliens offshore raccordés au réseau par des liaisons VSC-HVDC peuvent fournir rapidement de la puissance active, mais le soutien disponible est réparti entre plusieurs réserves physiques. Les rotors des éoliennes, le DC link HVDC et le stockage par batterie diffèrent par leur vitesse de réponse, l’énergie mobilisable, leur comportement en phase de récupération et leur sensibilité aux conditions de réseau faible. Un contrôleur réglé pour un seul point de fonctionnement peut ainsi améliorer le nadir de fréquence tout en sollicitant excessivement l’énergie cinétique du rotor, en abaissant la tension DC ou en utilisant de manière inefficace l’énergie de la batterie. Ce chapitre développe un cadre de co-conception à ordre réduit et sensible au risque pour un parc éolien offshore Type-4 agrégé, une liaison VSC-HVDC et un BESS couplé côté AC. Le modèle non linéaire conserve la fréquence réseau, la réponse primaire, la vitesse rotorique, l’actionnement de la puissance éolienne, l’énergie du DC link, le transfert HVDC, la puissance batterie, le state of charge et la mesure filtrée de fréquence. Trois stratégies sont évaluées : une référence non coordonnée, des gains supplémentaires fixes et un contrôleur adaptatif dont la participation de l’éolien, de l’HVDC et de la batterie évolue selon la réserve rotorique, la marge de tension DC, le state of charge, la marge convertisseur et la robustesse du réseau. Le vecteur de gains est choisi en minimisant la perte composite espérée conjointement avec la conditional value-at-risk (CVaR). La linéarisation numérique, les valeurs propres du Jacobien et les cartes d’abscisse spectrale sont utilisées pour le filtrage de stabilité locale, tandis que des scénarios Monte Carlo par Latin hypercube quantifient les performances sous incertitude. Sur la validation rapportée à 120 scénarios, la stratégie adaptative réduit la perte moyenne de 10,4 % et la 90%-CVaR de 6,4 % par rapport aux gains fixes, sans violation de contrainte observée dans l’échantillon. Les résultats mettent également en évidence un compromis pratique : une meilleure maîtrise rapide de la fréquence exige davantage d’énergie cinétique et batterie et peut réduire la marge locale d’amortissement.`
  },
  juri:{
    ...
    fr:`Les systèmes électriques renouvelables dominés par les convertisseurs sont de plus en plus vulnérables aux excursions rapides de fréquence, car le remplacement de la production synchrone réduit l’inertie effective du système. Cette étude évalue une stratégie de contrôle grid-forming (GFM) fondée sur une Virtual Synchronous Machine (VSM), soutenue par un Battery Energy Storage System (BESS) couplé côté DC, dans un système renouvelable VSC-HVDC représentatif à trois terminaux. La contribution principale est un modèle compact, réduit à cinq états, qui représente simultanément la fréquence AC, la tension du DC bus commun, la réponse du governor, la puissance active du BESS et la dynamique du state of charge, tout en permettant une évaluation reproductible de la stabilité couplée AC/DC sous plusieurs conditions de contingence. Le modèle a été vérifié indépendamment dans le logiciel à l’aide des solveurs adaptive BDF, Runge–Kutta d’ordre 4 à pas fixe et Radau, tandis que l’implémentation Simulink existante a été conservée comme vérification supplémentaire. Trois perturbations ont été étudiées : une hausse de charge de 280 MW, une perte de production éolienne de 400 MW et une rampe de puissance solaire de 300 MW sur 100 ms. Par rapport à la référence grid-following, le GFM-BESS améliore le nadir de fréquence de 1,615 à 1,616 Hz sur l’ensemble des scénarios testés et réduit la RoCoF mesurée sur 200 ms dans le cas sévère de perte éolienne, de 2,186 à 1,244 Hz/s. La tension du DC bus commun reste dans la limite d’étude de ±5 %. Le BESS atteint 99 % de sa puissance nominale de 200 MW en 0,117 à 0,166 s et ne fournit que 0,141 à 0,144 MWh jusqu’au nadir, ce qui montre que les performances à court terme sont principalement limitées par la capacité de puissance plutôt que par la capacité énergétique. Ces résultats mettent en évidence à la fois l’efficacité et les limites du stockage couplé côté DC pour un soutien coordonné de la fréquence et de la tension DC dans les systèmes DC multiterminaux à faible inertie.`
  }
};
