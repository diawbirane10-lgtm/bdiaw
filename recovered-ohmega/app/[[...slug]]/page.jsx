...
function HeroField({lang}){
  return <div className="heroField motionItem" aria-hidden="true">
    <div className="heroFieldHeader">
      <span>{lang==="fr"?"SYSTÈMES ÉLECTRIQUES / COMMANDE":"POWER SYSTEMS / CONTROL"}</span>
      <span>50 Hz</span>
    </div>
    <svg viewBox="0 0 720 460" focusable="false">
      <g className="fieldGrid">
        <line x1="60" y1="30" x2="60" y2="430"/><line x1="180" y1="30" x2="180" y2="430"/>
        <line x1="300" y1="30" x2="300" y2="430"/><line x1="420" y1="30" x2="420" y2="430"/>
        <line x1="540" y1="30" x2="540" y2="430"/><line x1="660" y1="30" x2="660" y2="430"/>
        <line x1="25" y1="90" x2="695" y2="90"/><line x1="25" y1="190" x2="695" y2="190"/>
        <line x1="25" y1="290" x2="695" y2="290"/><line x1="25" y1="390" x2="695" y2="390"/>
      </g>
      <g className="fieldNetwork">
        <path d="M72 337 L182 252 L295 315 L407 173 L525 226 L651 108"/>
        <circle cx="72" cy="337" r="7"/><circle cx="182" cy="252" r="7"/><circle cx="295" cy="315" r="7"/>
        <circle cx="407" cy="173" r="7"/><circle cx="525" cy="226" r="7"/><circle cx="651" cy="108" r="7"/>
      </g>
      <path className="fieldWave" d="M26 236 C74 236 83 170 132 170 S191 306 242 306 S301 205 356 205 S420 284 474 284 S537 146 596 146 S651 236 694 236"/>
      <line className="fieldSweep" x1="0" y1="34" x2="0" y2="426"/>
    </svg>
    <div className="heroFieldFooter">
      <span><b>01</b> GRID</span><span><b>02</b> CONTROL</span><span><b>03</b> AUTOMATION</span>
    </div>
  </div>
}
  ...
  return <>
    <header className="hero heroReveal" id="top">
      ...
      <div className="availabilityBar" aria-label={lang==="fr"?"Disponibilités":"Availability"}>
        ...
        <span>{lang==="fr"?"DISPONIBLE À L’INTERNATIONAL":"AVAILABLE WORLDWIDE"}</span>
        <strong>{lang==="fr"?"STAGES · RECHERCHE · COLLABORATIONS":"INTERNSHIPS · RESEARCH · COLLABORATIONS"}</strong>
      </div>
      <div className="heroStage">
        <div className="heroCopy">
          ...
          <div className="heroActions">
            <a className="heroPrimary" href="#projects">{lang==="fr"?"Voir les projets":"View selected work"} <span aria-hidden="true">↘</span></a>
            <a className="heroSecondary" href={mail}>{lang==="fr"?"Me contacter":"Contact"} <span aria-hidden="true">↗</span></a>
          </div>
        </div>
        <HeroField lang={lang}/>
      </div>
      <div className="heroTicker" aria-hidden="true">
        <div className="heroTickerTrack">
          <span>POWER SYSTEMS</span><i>×</i><span>GRID-FORMING</span><i>×</i><span>HVDC / HVAC</span><i>×</i><span>INDUSTRIAL AUTOMATION</span><i>×</i><span>DIGITAL TWINS</span><i>×</i><span>CRITICAL SYSTEMS</span><i>×</i>
          <span>POWER SYSTEMS</span><i>×</i><span>GRID-FORMING</span><i>×</i><span>HVDC / HVAC</span><i>×</i><span>INDUSTRIAL AUTOMATION</span><i>×</i><span>DIGITAL TWINS</span><i>×</i><span>CRITICAL SYSTEMS</span><i>×</i>
        </div>
      </div>
      <a className="heroScrollCue" href="#about" aria-label={lang==="fr"?"Découvrir le portfolio":"Explore the portfolio"}>
        <span>{lang==="fr"?"Explorer":"Explore"}</span><span aria-hidden="true">↓</span>
      </a>
    ...
    <Section id="about" title={lang==="fr"?"À propos":"About"} subtitle={lang==="fr"?"Profil d’ingénierie":"Engineering profile"}>
      ...
      <div className="disciplineStrip motionItem" aria-label={lang==="fr"?"Axes d’ingénierie":"Engineering focus areas"}>
        <span className="disciplineBlock isGreen"><b>01</b>{lang==="fr"?"Réseaux & puissance":"Power & grids"}</span>
        <span className="disciplineBlock isViolet"><b>02</b>{lang==="fr"?"Commande":"Control"}</span>
        <span className="disciplineBlock isBlue"><b>03</b>{lang==="fr"?"Automatisation":"Automation"}</span>
        <span className="disciplineBlock isYellow"><b>04</b>{lang==="fr"?"Systèmes critiques":"Critical systems"}</span>
      </div>
    ...
    <Section id="projects" title={lang==="fr"?"Projets sélectionnés":"Selected Work"} subtitle={lang==="fr"?"Une sélection parmi plus de 17 projets":"A selection from 17+ engineering projects"}>
      <div className="workList">
        {projects.map(p=><article className="workRow motionItem" key={p.slug}>
          ...
          <div className="workCardVisual"><img src={p.image} alt="" loading="lazy"/></div>
