...
const profileJsonLd = [
  ...
  },
  {
    ...
    description:
      'Electrical engineering profile with documented engineering contexts including SENELEC and ONEE case studies, IAEA/NEPIO institutional engagement, and engineering software from MathWorks, Siemens, Autodesk and DIgSILENT.',
    mentions: [
      { '@type': 'Organization', name: 'SENELEC', url: 'https://www.senelec.sn/' },
      { '@type': 'Organization', name: 'Office National de l’Électricité et de l’Eau Potable (ONEE)', url: 'https://www.one.org.ma/' },
      { '@type': 'Organization', name: 'International Atomic Energy Agency (IAEA)', url: 'https://www.iaea.org/' },
      { '@type': 'Organization', name: 'MathWorks', url: 'https://www.mathworks.com/' },
      { '@type': 'Organization', name: 'Siemens', url: 'https://www.siemens.com/' },
      { '@type': 'Organization', name: 'Autodesk', url: 'https://www.autodesk.com/' },
      { '@type': 'Organization', name: 'DIgSILENT', url: 'https://www.digsilent.de/' },
    ],
    mainEntity: {
      '@type': 'Person',
      '@id': siteUrl + '/#birane-diaw',
